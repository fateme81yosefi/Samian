...
function Message(props) {
    ...
    constvvv=target.getHours
    constvvv=target.getMinutes
    constvvv=target.getSeconds
    ...
    const render = () => {
        return <div className="Message">
            ...
            <div className='repAndDetail'>
                ...
                <div className='date'>
                    <div className='ago' style={{ color: "red", paddingRight: "20px" }}>    ({diffSeconds}روز قبل )</div>
