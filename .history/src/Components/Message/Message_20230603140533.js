...
function Message(props) {
    ...
    const dateeee3= target.getDay()
        ...
        const updatedItems =(index)=> data.map(item => {
            if (item.id === 2) {
              return { ...item, isImportant: !item. };
            }
            return item;
          });
        ...
        return <div className="Message">
            ...
            <div className='repAndDetail'>
                ...
                <div className='icon2'>
                    ...
                    {dataInfo.isImportant ? <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="yellow" class="bi bi-star-fill" viewBox="0 0 16 16">
