...
function Message(props) {
    ...
    const dateeee1= target.getMonth
    const dateeee2= target.getY
    const dateeee2= target.getMonth
        ...
        return <div className="Message">
            ...
            <div className='repAndDetail'>
                ...
                <div className='date'>
                    ...
                    <div className='datee'>{dateeee}</div>
                    <div className='ago' style={{ color: "red", paddingRight: "20px",paddingLeft: "20px" }}>    ({diffSeconds}روز قبل )</div>
