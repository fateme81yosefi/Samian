        ...
        return <div className="Message">
            ...
            <div className='repAndDetail'>
                ...
                <div className='icon2'>
                    ...
                    {dataInfo.isImportant ? <svg onClick={()=>{updatedItems(dataIn)}} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="yellow" class="bi bi-star-fill" viewBox="0 0 16 16">
