    ...
    const render = () => {
        ...
        return <div className="Message">
            ...
            <div className='repAndDetail'>
                ...
                <div className='icon4' onClick={()=>window.Loca}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-reply" viewBox="0 0 16 16">
