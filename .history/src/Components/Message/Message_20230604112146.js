...
function Message(props) {
    ...
    const render = () => {
        ...
        return <div className="Message">
            <div className='containInfoo' >
                <div className='avatarAndTitle' onClick={() => document.getElementById(`${dataInfo.uniqueid}textAndReciver`).style.display = "flex"} >
                    <div className='avatar'><img src={dataInfo.fromcontactimage}></img></div>
                ...
                <div className='repAndDetail'>
                    ...
                    <div className='icon4' onClick={() => { document.getElementById(`${dataInfo.uniqueid}vv`).style.display = "flex"; document.getElementById(`${dataInfo.uniqueid}`).style.display = "flex" }}>
            ...
            <div className='textAndReciver' id={`${dataInfo.uniqueid}textAndReciver`}>
                <div className='reciiver'><b>گیرنده:</b> {dataInfo.tocontactinfo}</div>

                <div className='text'><b>متن پیام:</b> {dataInfo.messagebody}</div>
            ...
            <div className='containRep'>
                ...
                <button className="send" id={`${dataInfo.uniqueid}vv`} onClick={() => {
                    dispatch(addToData({
                        ...
                        deadlinedate: "",
                        flagduedate: "",
                        fromcontactimage: "https://www.pngitem.com/pimgs/m/226-2260470_transparent-admin-icon-png-admin-logo-png-png.png",
                        fromcontactinfo: "ادمین 1",
                        isImportant: false,
                        lablecolor1: "red",
                        lablecolor2: "blue",
                        lablecolor3: "yellow",
                        messagebody: document.getElementById(`${dataInfo.uniqueid}`).value,
                        subject: `پاسخ به نامه :  ${dataInfo.subject}`,
                        tocontactinfo: dataInfo.contactinfo,
                        uniqueid: `${dataInfo.uniqueid}bbb`
                    }));
                    document.getElementById(`${dataInfo.uniqueid}vv`).style.display = "none"; document.getElementById(`${dataInfo.uniqueid}`).style.display = "none"
                }}>ارسال</button>
            </div>
        </div>
