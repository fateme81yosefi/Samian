            ...
            <div className='repAndDetail'>
                ...
                <div className='icon2'>
                    ...
                    {dataInfo.isImportant ? <svg onClick={() => { updateData(dataInfo.uniqueid, !dataInfo.isImportant) }} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#FFD600" class="bi bi-star-fill" viewBox="0 0 16 16">
                        ...
                        <svg onClick={() => { updateData(dataInfo.uniqueid, !dataInfo.isImportant) }} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-star" viewBox="0 0 16 16">
