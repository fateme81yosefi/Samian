...
function Message(props) {
    ...
    // تاریخ و زمان دلخواه (به صورت رشته)
    const targetDate = dataInfo.
    const now = new Date();
    
    // تاریخ و زمان دلخواه (به صورت رشته)
    const targetDate = '2022-01-01T00:00:00';
    ...
    const render = () => {
        return <div className="Message">
            ...
            <div className='repAndDetail'>
                ...
                <div className='date'>
                    <div className='time'>11:33</div>
                    <div className='datee'>23/2/1402</div>
                    <div className='ago'> {dataInfo.createdate}</div>
