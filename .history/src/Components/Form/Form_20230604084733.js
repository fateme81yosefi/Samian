    ...
    return (
        ...
        <div className="containTextArea">
            ...
            <button className="send" onClick={() => dispatch(addToData([{
                 ...
                 fromcontactinfo: "", isImportant: true, lablecolor1: "red", lablecolor2: "blue", lablecolor3: "yellow", messagebody: "fkjdlsg", subject: "jdsbf", tocontactinfo: "f,sdbhf", uniqueid: "534bvhvcxzysgd7834rjhsdb"
    )
}