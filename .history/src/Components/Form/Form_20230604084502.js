...
export default function Form() {
    ...
    return (
        ...
        <div className="containTextArea">
            ...
            <button className="send" onClick={()=>dispatch(addToData([{contactinfo:"gfgfd", createdate:"jfb",createuserid:"",deadlinedate:"",flagduedate:"" ,fromcontactimage:"", fromcontactinfo:"",isImportant:true ,lablecolor1:"red" , lablecolor2:"blue" , lablecolor2 }]))}>ارسال</button>
        </div>
    )
}